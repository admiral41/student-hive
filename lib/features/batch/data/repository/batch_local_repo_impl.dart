...
final batchLocalRepositoryImplProvider = Provider.autoDispose<IBatchRepository>(
        (ref) => BatchLocalRepositoryImpl(batchLocalDataSource: ref.read(batchLocalDataSourceProvider))
);
